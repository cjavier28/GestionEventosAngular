...
export function apiServicioGestionEventosInscribirPost(http: HttpClient, rootUrl: string, params?: ApiServicioGestionEventosInscribirPost$Params, context?: HttpContext): Observable<StrictHttpResponse<void>> {
